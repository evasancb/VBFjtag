...
@tf.function(input_signature=[tf.TensorSpec([1, 10, 11], tf.float32, name="MyInput")], jit_compile=True)
...
import numpy as np
print(infer_no_batch.get_concrete_function()(np.random.rand(1, 10, 11)))
