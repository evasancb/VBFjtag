...
namespace InputVars{
    enum vars { jet_valid = 0, jet_pt = 1, jet_eta = 2, rel_jet_M_pt = 3, rel_jet_E_pt = 4, jet_htt_deta = 5,
                jet_btagScore = 6, jet_htt_dphi = 7, jet_isbjet = 8, sample_year= 9, channelId = 10, htt_pt = 11, htt_eta = 12,
                htt_met_dphi = 13, rel_met_pt_htt_pt = 14, htt_scalar_pt = 15
    };
 }
...
public:
    ...
    static constexpr size_t n_variables = 16;
